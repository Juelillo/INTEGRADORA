<template>
  <button
    class="btn btn-square btn-outline w-48 mt-3 ml-1 h-64 absolute top-180 bg-[#F7934C] border-[#F7934C] hover:bg-[#1F1300] hover:text-[#FFC15E] transition-colors duration-300 h-96" style="border-color:transparent;">
